...
time.sleep(1)
b = pd.read_csv(name)
g = pd.DataFrame.as_matrix(b)
numcol = len(b.columns)
print('\n[+] '+str(numcol)+' classifications found.')
time.sleep(1)

attributes_array = ["outlook", "temperature", "humidity", "windy"]
...
if __name__ == "__main__":
    ...
    tree = create_decision_tree( g, attributes_array, attributes_array[1], gain_ratio )
